                      ...
                      <div class="col-md-6">
                        <form method ="post" action="#">
                            ...
                            if($_POST['simpanEdit']){
                                ...
                                $matkul=$_POST['matkul'];
                                $alamat=$_POST['alamat'];
                                $sql="update dosen set nidn='$nidn', nama='$nama', gender='$jk', matkul='$matkul', alamat='$alamat' where id='$idx'";
                            ...
                            <table class="table table-bordered">
                              <?php
                               ...
                               switch($d['matkul']){
                                   case'1':
                                       $matkul1="Pemograman Web";
                                       break;
                                   case'2':
                                       $matkul2="Sistem Informasi";
                                       break;
                                   default:
                                       $matkul0="Tidak Diketahui";
                                       break;
                               }
                                 ...
                                 <select name='matkul' class='form-control'>
                                     <option value='1'"; if($d['matkul']=='1') echo"selected"; echo">Pemograman Web</option>
                                     <option value='2'"; if($d['matkul']=='2') echo"selected"; echo">Sistem Informasi</option>
                                    </select></td></tr>";
                                    echo"<tr><td></td><td>
