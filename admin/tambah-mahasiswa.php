                    ...
                    <div class="row">
                      ...
                      <div class="col-lg-12">
                        ...
                        if ($_POST['simpan']){
                            ...
                            $sql = "insert into mahasiswa set nim='$nim',nama='$nama',gender='$gender',alamat='$alamat',prodi='$prodi',waktu='$waktu'";
                            $tes = $db->query($sql);
                            if($tes){
                        ...
                        <form method="post" action="#">
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td>
                                    <input type="radio" name="gender" value="M" id="genderM" <?php if($gender=="M") echo"checked"; ?>><label for="genderM">Male</label>
                                    <input type="radio" name="gender" value="F" id="genderF" <?php if($gender=="F") echo"checked"; ?>><label for="genderF">Female</label>
                                    </td>
                                </tr>
                                <tr>
                                    <td valign="top">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select name="prodi" class="form-control">
                                            <option value="1"<?php if($prodi=="1") echo "selected;"?>>Teknik Informatika</option>
                                            <option value="2"<?php if($prodi=="2") echo "selected;"?>>Sistem Informasi</option>
                                        </select>
                                    </td>
                                </tr>
                                <tr>
