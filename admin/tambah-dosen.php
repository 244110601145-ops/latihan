                    ...
                    <div class="row">
                      ...
                      <div class="col-lg-12">
                        ...
                        if ($_POST['simpan']){
                            ...
                            $sql = "insert into dosen set nidn='$nidn',nama='$nama',gender='$gender', alamat='$alamat',matkul='$matkul',waktu='$waktu'";
                            $tes = $db->query($sql);
                            if($tes){
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select name="matkul" class="form-control">
                                            <option value="1"<?php if($matkul=="1") echo "selected;"?>>Pemograman Web</option>
                                            <option value="2"<?php if($matkul=="2") echo "selected;"?>>Sistem Informasi</option>
                                        </select>
                                    </td>
                                </tr>
                                <tr>
