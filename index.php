        ...
        <div class="card-body login-card-body">
            ...
            if ($_POST['btnLogin']){
                ...
                if ($jml>0){
                    ...
                    echo"<div class='alert alert-danger alert-dismissible'>Login Gagal, username atau password salah</div>";
            }
        }
            ?>
          <form action="#" method="post">
            <div class="input-group mb-3">
              <input type="text" class="form-control" placeholder="User Name" name="tuser" required />
