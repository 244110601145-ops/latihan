...
<html lang="en">
  ...
  <head>
    ...
    <title>SIAKAD | Sistem Informasi AKdemik</title>
  ...
  <body class="sidebar-expand-lg sidebar-open bg-body-tertiary">
    ...
    <div class="app-wrapper">
          ...
          <ul class="navbar-nav ms-auto">
                ...
                <a href="#" class="dropdown-item">
                  ...
                  <div class="d-flex">
                    <div class="flex-shrink-0">
                      <img
                        src="../admin/9441b3dc-88f9-40dd-b090-b3ac4a5dcff2.jpg"
                        alt="User Avatar"
                    ...
                    <div class="flex-grow-1">
                      ...
                      <p class="fs-7">WOII TUGASS SELESAIIN!!</p>
                ...
                <a href="#" class="dropdown-item">
                  ...
                  <div class="d-flex">
                    ...
                    <div class="flex-grow-1">
                      ...
                      <p class="fs-7">kaka lagi ngapain?</p>
                      <p class="fs-7 text-secondary">
                        <i class="bi bi-clock-fill me-1"></i> 4 Hours Ago
                      </p>
                    </div>
                ...
                <a href="#" class="dropdown-item">
                  ...
                  <div class="d-flex">
                    ...
                    <div class="flex-grow-1">
                      ...
                      <p class="fs-7">Sayang lagi dimana?</p>
                      <p class="fs-7 text-secondary">
                        <i class="bi bi-clock-fill me-1"></i> 4 Hours Ago
                      </p>
                    </div>
            ...
            <li class="nav-item dropdown user-menu">
              <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                <img
                  src="../admin/f636ca17-bddf-4ca9-9a71-03fa87a34528.jpg"
                  class="user-image rounded-circle shadow"
                  alt="User Image"
                />
                <span class="d-none d-md-inline">Nihayatuzzain Abdillah</span>
              </a>
              <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-end">
                ...
                <li class="user-header text-bg-primary">
                  ...
                  />
                  <p>
                    Nihayatuzzain Abdillah - Mahasiswa
                ...
                <li class="user-footer">
                  ...
                  <a href="../index.php" class="btn btn-default btn-flat float-end">Sign out</a>
                </li>
                <!--end::Menu Footer-->
              </ul>
            </li>
      ...
      <!--end::Header-->
      <!--begin::Sidebar-->
      <aside class="app-sidebar bg-warning shadow" data-bs-theme="light">
        <!--begin::Sidebar Brand-->
      ...
      <main class="app-main">
        ...
        <div class="app-content-header">
          ...
          <div class="container-fluid">
            ...
            <div class="row">
              <!--begin::Col-->
              <div class="col-sm-6"><h3 class="mb-0">Menu Utama</h3></div>
              <!--end::Col-->
              <!--begin::Col-->
              <div class="col-sm-6">
